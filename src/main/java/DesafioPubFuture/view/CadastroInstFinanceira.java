 ...
 * @author PC
 */
public class CadastroInstFinanceira extends javax.swing.JFrame {

    /**
     * Creates new form CadastroInstFinanceira
     */
    public CadastroInstFinanceira() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastro de Inst. Financeira");
    ...
    private void jButtonSalvaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvaActionPerformed
        ...
        try {
            instFinanceiraController.cadastraInstFinanceira(jTextNome.getText());
            jTextNome.setText("");
            JOptionPane.showMessageDialog(null," Cadastro efetuado com sucesso");
        } catch (ExceptionDAO | SQLException ex) {
            Logger.getLogger(CadastroInstFinanceira.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroInstFinanceira.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
