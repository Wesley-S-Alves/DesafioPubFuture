 ...
 * @author PC
 */
public class AlteraTipoReceita extends javax.swing.JFrame {

    
    
    public AlteraTipoReceita() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Alterar Tipo de Receita");
    ...
    private void jButtonSalvaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvaActionPerformed
        ...
        try {
            tipoReceitaController.alteraTipoReceita(Integer.valueOf(jLabelId.getText()), jTextFieldNome.getText());
        } catch (SQLException | ExceptionDAO ex) {
            Logger.getLogger(AlteraTipoReceita.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlteraTipoReceita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlteraTipoReceita().setVisible(true);
            }
        });
    }
    ...
    public volatile javax.swing.JTextField jTextFieldNome;
